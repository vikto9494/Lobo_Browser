...
//	public final BookmarksAction bookmarksAction = new BookmarksAction();
	...
	public final AddBestSearchAction addBestSearchAction = new AddBestSearchAction();
	public final AddSearchDownloadAction addSearchDownloadAction = new AddSearchDownloadAction();
	...
	public void searchDownload() {
		...
		if(entry != null) {
			...
			JDialog dialog = new SearchDownloadDialog((java.awt.Frame) awtWindow, true);
			dialog.setTitle("Search&Download");
			dialog.setLocationByPlatform(true);
			dialog.setLocation(awtWindow.getLocationOnScreen().x + 300, awtWindow.getLocationOnScreen().y + 250);
			dialog.setResizable(false);
			dialog.pack();
			dialog.setVisible(true);
		}
	...
	public void bestSearch() {
		...
		if(entry != null) {
			...
			JDialog dialog = new BestSearchDialog((java.awt.Frame) awtWindow, true);
			dialog.setTitle("Best search");
			dialog.setLocationByPlatform(true);
			dialog.setLocation(awtWindow.getLocationOnScreen().x + 300, awtWindow.getLocationOnScreen().y + 250);
			dialog.setResizable(false);
			dialog.pack();
...
//	}
	...
	class AddBestSearchAction extends AbstractAction {		
		public void actionPerformed(ActionEvent e) {
			bestSearch();
		}
	}
	
	class AddSearchDownloadAction extends AbstractAction {		
		public void actionPerformed(ActionEvent e) {
			searchDownload();
		}
	}
