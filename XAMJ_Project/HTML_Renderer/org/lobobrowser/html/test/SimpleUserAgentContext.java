...
public class SimpleUserAgentContext implements UserAgentContext {
	...
	private String userAgent = "Mozilla/1.0 (compatible; MSIE 6.0;) Cobra/Simple";
	...
	/**
	 * Determines whether loading of CSS files should be enabled.
    ...
    /**
     * Determines whether STYLE tags should be processed.
     * This implementation returns the value of a local field
     * defaulting to <code>true</code>.
