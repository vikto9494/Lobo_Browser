...
public class StringListControl extends JComponent {
	...
	/**
	 * Constructor for StringListControl, get opportunities to change comboBox items
	 * @param needEditOpportunities
	 */
	public StringListControl(boolean needEditOpportunities) {
		this.setLayout(new BoxLayout(this, BoxLayout.X_AXIS));
		this.comboBox = new JComboBox();
		this.comboBox.setEditable(false);
		this.add(this.comboBox);
		if (needEditOpportunities)
		{
			JButton editButton = new JButton();
			editButton.setAction(new EditAction());
			editButton.setText("Edit List");
