...
//	
	...
	public HtmlRendererContext open(java.net.URL urlObj, String windowName, String windowFeatures, boolean replace) {
		Properties windowProperties = windowFeatures == null ? null : org.lobobrowser.gui.NavigatorWindowImpl.getPropertiesFromWindowFeatures(windowFeatures);
		try {
	...
	public UserAgentContext getUserAgentContext() {
		if(this.uaContext == null) {
			synchronized(this) {
				if(this.uaContext == null) {
					this.uaContext = new UserAgentContextImpl(this.clientletFrame);
				}
			}
		}
	...
	public static class LocalParameterInfo implements ParameterInfo {
