...
public class DirectorySource {	
	...
	public JMenu getDirectoryMenu() {
		...
		searchMenu.add(this.getBestSearchMenu());
		...
		menu.add(newsMenu);
		menu.add(infoMenu);
		menu.add(ComponentSource.menuItem("Search&Download", 'S', "ctrl shift s", this.actionPool.addSearchDownloadAction));
		return menu;
	}
	...
	private JMenuItem getBestSearchMenu() {
		return ComponentSource.menuItem("Best search", this.actionPool.addBestSearchAction);
	}
